  ...
  return (
    <div className="relative min-h-screen font-sans text-[#0F2963] bg-[#FFFDF8] bg-playful-dots selection:bg-vannam-yellow/20 selection:text-vannam-orange">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-[#CBD8F6]/80 shadow-xs">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-3 xl:gap-6">
          ...
          <Link href="/" className="flex items-center group shrink-0">
            <img 
              ...
              className="h-10 sm:h-12 lg:h-13 xl:h-14 w-auto object-contain group-hover:scale-105 transition transform"
            />
          </Link>
          ...
          <button
            ...
            className="lg:hidden p-2.5 rounded-xl bg-[#E8EEFB] text-[#0F2963] hover:bg-slate-200 transition"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden fixed inset-0 z-[100] bg-white overflow-y-auto scrollbar-none animate-in fade-in slide-in-from-top-4 duration-300 flex flex-col justify-between p-5 pb-12">
            <div className="space-y-5">
              
              {/* Header with Logo & Close */}
              <div className="sticky top-0 bg-white z-20 flex items-center justify-between border-b border-[#E8EEFB] pb-4 pt-1">
                ...
                <button
                  ...
                  className="p-2.5 rounded-full bg-[#F0F4FC] hover:bg-rose-50 text-[#0F2963] hover:text-[#E11D48] active:scale-95 transition border border-[#CBD8F6] flex items-center justify-center shadow-xs"
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs font-extrabold text-[#0F2963]">
                  <a href="#about" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-amber-50 active:bg-amber-100 flex items-center gap-2 transition">🏫 About Us</a>
                  <a href="#programs" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-emerald-50 active:bg-emerald-100 flex items-center gap-2 transition">🎨 Programs</a>
                  <a href="#why-us" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-amber-50 active:bg-amber-100 flex items-center gap-2 transition">⭐ Why Us</a>
                  <a href="#approach" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-sky-50 active:bg-sky-100 flex items-center gap-2 transition">🌱 Approach</a>
                  <a href="#activities" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-rose-50 active:bg-rose-100 flex items-center gap-2 transition">🧸 Activities</a>
                  <a href="#facilities" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-emerald-50 active:bg-emerald-100 flex items-center gap-2 transition">🏰 Facilities</a>
                  <a href="#safety" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-blue-50 active:bg-blue-100 flex items-center gap-2 transition">🛡️ Safety</a>
                  <a href="#awards" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-amber-50 active:bg-amber-100 flex items-center gap-2 transition">🏆 Awards</a>
                  <a href="#teachers" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-amber-50 active:bg-amber-100 flex items-center gap-2 transition">👩‍🏫 Teachers</a>
                  <a href="#gallery" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-sky-50 active:bg-sky-100 flex items-center gap-2 transition">📸 Gallery</a>
                  <a href="#testimonials" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-rose-50 active:bg-rose-100 flex items-center gap-2 transition">💬 Reviews</a>
                  <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="p-3 rounded-2xl bg-[#F0F4FC] hover:bg-emerald-50 active:bg-emerald-100 flex items-center gap-2 transition">📍 Contact</a>
                </div>
              </div>
              ...
              <div className="pt-2 flex flex-col gap-2.5 border-t border-[#E8EEFB]">
                <button
                  ...
                  className="btn-primary w-full py-3.5 text-center text-xs sm:text-sm font-black flex items-center justify-center gap-2 shadow-md"
                >
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="btn-cyan w-full py-3 text-center text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="btn-secondary w-full py-3 text-center text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm"
                  >
              ...
              <div className="pt-1 text-center text-xs font-bold text-[#64748B]">
                <a href="tel:+18005557529" className="text-vannam-orange flex items-center justify-center gap-1.5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left relative">
              ...
              {/* Sub-paragraph */}
              <p className="text-xs sm:text-base lg:text-lg text-[#334155] max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              ...
              {/* Dual Action CTAs - Responsive Side-by-Side on Mobile */}
              <div className="grid grid-cols-2 sm:flex sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-2.5 sm:gap-4 pt-1 sm:pt-2">
                <button
                  onClick={() => { triggerConfetti(); setIsTourModalOpen(true); }}
                  className="btn-primary w-full sm:w-auto px-3 sm:px-8 py-2.5 sm:py-3.5 text-xs sm:text-base flex items-center justify-center gap-1.5 sm:gap-2.5 shadow-md whitespace-nowrap"
                >
                  <Calendar className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-vannam-yellow shrink-0" />
                  <span>Book a Visit</span>
                </button>

                <a
                  href="#programs"
                  className="btn-secondary w-full sm:w-auto px-3 sm:px-7 py-2.5 sm:py-3.5 text-xs sm:text-base flex items-center justify-center gap-1 sm:gap-2 whitespace-nowrap"
                >
                  <span>Explore Programs</span>
                  <ChevronRight className="w-3.5 h-3.5 text-vannam-navy shrink-0" />
                </a>
              </div>

              {/* Trust Indicator Pills */}
              <div className="pt-3 sm:pt-6 border-t border-[#CBD8F6]/80 grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-3 text-left">
                <div className="flex items-center gap-1.5 sm:gap-2.5 p-1.5 sm:p-2 rounded-xl bg-white/70 border border-vannam-green/20 shadow-2xs">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-vannam-green/10 flex items-center justify-center text-vannam-green font-bold text-[10px] sm:text-xs shrink-0">
                    1:4
                  </div>
                  <span className="text-[10px] sm:text-xs font-bold text-[#0F2963] leading-tight">Low Ratio Care</span>
                </div>
                <div className="flex items-center gap-1.5 sm:gap-2.5 p-1.5 sm:p-2 rounded-xl bg-white/70 border border-vannam-yellow/20 shadow-2xs">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-vannam-yellow/10 flex items-center justify-center text-vannam-orange shrink-0">
                    <ShieldCheck className="w-3 h-3 sm:w-4 sm:h-4" />
                  </div>
                  <span className="text-[10px] sm:text-xs font-bold text-[#0F2963] leading-tight">24/7 Live CCTV</span>
                </div>
                <div className="flex items-center gap-1.5 sm:gap-2.5 p-1.5 sm:p-2 rounded-xl bg-white/70 border border-vannam-red/20 shadow-2xs">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-vannam-red/10 flex items-center justify-center text-vannam-red shrink-0">
                    <Heart className="w-3 h-3 sm:w-4 sm:h-4" />
                  </div>
                  <span className="text-[10px] sm:text-xs font-bold text-[#0F2963] leading-tight">Organic Meals</span>
                </div>
                <div className="flex items-center gap-1.5 sm:gap-2.5 p-1.5 sm:p-2 rounded-xl bg-white/70 border border-vannam-cyan/20 shadow-2xs">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-vannam-cyan/10 flex items-center justify-center text-vannam-cyan shrink-0">
                    <Award className="w-3 h-3 sm:w-4 sm:h-4" />
                  </div>
                  <span className="text-[10px] sm:text-xs font-bold text-[#0F2963] leading-tight">CPR Certified</span>
                </div>
              </div>
              ...
              <div className="relative mx-auto max-w-md lg:max-w-none">
                <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border-4 border-vannam-yellow/30 shadow-xl bg-white aspect-[16/11] sm:aspect-square">
                  ...
                  <div className="absolute bottom-2.5 left-2.5 right-2.5 sm:bottom-4 sm:left-4 sm:right-4 bg-white/95 backdrop-blur-md p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border border-[#E8EEFB] shadow-lg flex items-center justify-between gap-2">
                    ...
                    <button 
                      onClick={() => setIsTourModalOpen(true)}
                      className="btn-accent px-3 py-1.5 sm:px-4 sm:py-2 text-[11px] sm:text-xs flex items-center gap-1 shrink-0"
                    >
                      <span>Apply Now</span>
                    </button>
                  </div>
                ...
                {/* Floating Decorative Card 3 - REMOVED */}
      ...
      {/* ABOUT SECTION */}
      <section id="about" className="scroll-mt-24 py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-[#0F2963]">
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory scrollbar-none gap-4 pb-4 mb-6 md:mb-16 md:grid md:grid-cols-3 md:gap-8 md:overflow-visible -mx-4 px-4 sm:mx-0 sm:px-0">
            
            {/* Philosophy Card */}
            <div className="bento-card card-amber p-6 sm:p-8 space-y-4 relative group w-[82vw] sm:w-[340px] md:w-auto shrink-0 md:shrink snap-center flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 rounded-2xl bg-vannam-yellow text-[#0F2963] flex items-center justify-center shadow-md">
                    <Heart className="w-6 h-6" />
                  </div>
                  <TeddyBearIcon className="w-7 h-7 opacity-70 group-hover:scale-110 transition" />
                </div>
                <h3 className="font-heading text-xl sm:text-2xl font-bold text-[#0F2963] mb-2">Our Philosophy</h3>
            ...
            {/* Mission Card */}
            <div className="bento-card card-emerald p-6 sm:p-8 space-y-4 relative group w-[82vw] sm:w-[340px] md:w-auto shrink-0 md:shrink snap-center flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 rounded-2xl bg-vannam-green text-white flex items-center justify-center shadow-md">
                    <Sun className="w-6 h-6" />
                  </div>
                  <PuzzlePieceIcon color="emerald" className="w-7 h-7 opacity-80 group-hover:scale-110 transition" />
                </div>
                <h3 className="font-heading text-xl sm:text-2xl font-bold text-[#0F2963] mb-2">Our Mission</h3>
                <p className="text-xs sm:text-sm text-[#0F2963] leading-relaxed">
            ...
            {/* Vision Card */}
            <div className="bento-card card-sky p-6 sm:p-8 space-y-4 relative group w-[82vw] sm:w-[340px] md:w-auto shrink-0 md:shrink snap-center flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 rounded-2xl bg-vannam-cyan text-white flex items-center justify-center shadow-md">
                    <Globe className="w-6 h-6" />
                  </div>
                  <KiteIcon className="w-7 h-7 opacity-80 group-hover:scale-110 transition" />
                </div>
                <h3 className="font-heading text-xl sm:text-2xl font-bold text-[#0F2963] mb-2">Our Vision</h3>
                <p className="text-xs sm:text-sm text-[#0F2963] leading-relaxed">
          ...
          <div className="bg-[#0F2963] text-white rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl border-4 border-[#091A42] grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 text-center relative overflow-hidden">
            <div className="space-y-1 relative">
              <Counter end={12} className="font-heading text-3xl sm:text-4xl md:text-5xl font-extrabold text-vannam-yellow block" />
              <span className="text-xs sm:text-sm font-semibold text-blue-100">Years of Experience</span>
            </div>
            <div className="space-y-1 relative">
              <Counter end={1500} className="font-heading text-3xl sm:text-4xl md:text-5xl font-extrabold text-vannam-green block" />
              <span className="text-xs sm:text-sm font-semibold text-blue-100">Happy Children</span>
            </div>
            <div className="space-y-1 relative">
              <Counter end={25} className="font-heading text-3xl sm:text-4xl md:text-5xl font-extrabold text-vannam-cyan block" />
              <span className="text-xs sm:text-sm font-semibold text-blue-100">Qualified Teachers</span>
            </div>
            <div className="space-y-1 relative">
              <Counter end={100} className="font-heading text-3xl sm:text-4xl md:text-5xl font-extrabold text-vannam-red block" />
      ...
      <section id="programs" className="scroll-mt-24 py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2.5 overflow-x-auto pb-3 mb-10 scrollbar-none snap-x justify-start sm:justify-center px-1">
            {Object.keys(programsData).map((key) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 sm:px-5 py-2.5 sm:py-3 rounded-2xl text-xs sm:text-sm font-extrabold flex items-center gap-2 transition shrink-0 snap-center ${
          ...
          {activeProgramTab && (
            <div className="max-w-4xl mx-auto">
              <div className={`bento-card ${programsData[activeProgramTab].cardStyle} p-8 sm:p-12 transition-all duration-300 relative overflow-hidden`}>
                
                {/* Decorative Toy Watermark */}
                <div className="absolute top-4 right-4 opacity-20 pointer-events-none">
                  {programsData[activeProgramTab].toyType === "teddy" && <TeddyBearIcon className="w-24 h-24" />}
                  {programsData[activeProgramTab].toyType === "blocks" && <AlphabetBlock letter="1" color="amber" className="w-24 h-24" />}
                  {programsData[activeProgramTab].toyType === "puzzle" && <PuzzlePieceIcon color="emerald" className="w-24 h-24" />}
                  {programsData[activeProgramTab].toyType === "crayons" && <CrayonIcon color="sky" className="w-24 h-24" />}
                  {programsData[activeProgramTab].toyType === "storybook" && <StorybookIcon className="w-24 h-24" />}
                </div>
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6 relative">
                  <div>
                    ...
                    <h3 className="font-heading text-3xl font-extrabold text-[#0F2963]">
                      {programsData[activeProgramTab].title}
                    </h3>
                  </div>

                  <span className="px-4 py-2 rounded-xl bg-white/90 font-bold text-xs text-[#0F2963] border border-[#CBD8F6] shadow-xs">
                    {programsData[activeProgramTab].ratio}
                  </span>
                </div>

                <p className="text-base text-[#0F2963] leading-relaxed mb-8 relative">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8 relative">
                  ...
                  {/* Learning Objectives */}
                  <div className="bg-white/90 rounded-2xl p-6 border border-[#CBD8F6]/80 shadow-xs space-y-3">
                    <h4 className="font-heading font-extrabold text-[#0F2963] text-lg flex items-center gap-2">
                      <CheckCircle2 className="w-5 h-5 text-vannam-green" />
                      <span>Key Learning Objectives</span>
                    </h4>
                    <ul className="space-y-2 text-sm text-[#0F2963]">
                  ...
                  <div className="bg-white/90 rounded-2xl p-6 border border-[#CBD8F6]/80 shadow-xs space-y-3">
                    <h4 className="font-heading font-extrabold text-[#0F2963] text-lg flex items-center gap-2">
                      <Play className="w-5 h-5 text-vannam-yellow" />
                      <span>Core Daily Activities</span>
                    </h4>
                    <div className="flex flex-wrap gap-2 pt-1">
                      {programsData[activeProgramTab].activities.map((act, i) => (
                        <span key={i} className="px-3 py-1.5 bg-[#E8EEFB]/90 rounded-xl text-xs font-bold text-[#0F2963] flex items-center gap-1.5">
                          <Check className="w-3 h-3 text-vannam-green" />
                          <span>{act}</span>
                        </span>
                      ))}
                    </div>
                ...
                {/* Enquire CTA */}
                <div className="flex items-center justify-between pt-4 border-t border-[#0F2963]/10 relative">
                  <span className="text-xs font-bold text-[#334155]">
                    Interested in {programsData[activeProgramTab].title}?
                  </span>
                  <button
                    onClick={() => setIsTourModalOpen(true)}
                    className="btn-primary px-6 py-3 text-xs sm:text-sm"
                  >
      ...
      <section id="why-us" className="scroll-mt-24 py-20 lg:py-28 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-10">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-[#0F2963] tracking-tight leading-tight">
          ...
          <div className="flex overflow-x-auto sm:grid sm:grid-cols-3 lg:grid-cols-6 gap-3 pb-3 sm:pb-0 scrollbar-none snap-x snap-mandatory -mx-4 px-4 sm:mx-0 sm:px-0">
            {differentiators.map((item, idx) => {
              ...
              return (
                <button
                  ...
                  className={`min-w-[140px] xs:min-w-[155px] sm:min-w-0 flex-1 snap-start p-3.5 rounded-2xl border-2 transition-all duration-300 flex flex-col items-center justify-center text-center gap-2 shrink-0 sm:shrink ${
                    isSelected
                ...
                >
                  ...
                  <span className="text-xs font-extrabold leading-tight">{item.shortTitle}</span>
          ...
          {/* INNOVATIVE DUAL-PANEL COMPARISON COCKPIT */}
          {(() => {
            const current = differentiators[activeWhyUsTab];
            return (
              <div className="bg-white rounded-3xl sm:rounded-[2.5rem] border-2 sm:border-4 border-[#CBD8F6] shadow-2xl p-4 sm:p-10 relative overflow-hidden animate-in fade-in zoom-in-95">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-[#E8EEFB]">
                  <div className="flex items-center gap-3 text-center sm:text-left">
                    <span className="text-3xl sm:text-4xl p-2 sm:p-2.5 rounded-2xl bg-[#F0F4FC] border border-[#CBD8F6] shrink-0">{current.icon}</span>
                    <div>
                      <span className="text-[10px] sm:text-xs font-black uppercase tracking-wider text-[#00A8E8] block">{current.highlight}</span>
                      <h3 className="font-heading font-extrabold text-lg sm:text-2xl text-[#0F2963] leading-tight">{current.feature}</h3>
                    </div>
                  </div>
                ...
                {/* Split Dual-Panel Comparison Cockpit (Side by Side Horizontal on all screens) */}
                <div className="grid grid-cols-2 gap-2.5 sm:gap-8 pt-5 sm:pt-8 items-stretch">
                  
                  {/* LEFT PANEL: VANNAM WORLD (98% VISUAL GAUGE) */}
                  <div className="bg-gradient-to-br from-[#ECFDF5] to-[#D1FAE5] rounded-2xl sm:rounded-3xl p-3 sm:p-8 border sm:border-2 border-[#A7F3D0] space-y-3 sm:space-y-6 relative overflow-hidden shadow-sm flex flex-col justify-between">
                    <div className="space-y-3 sm:space-y-6">
                      <div className="flex flex-col xs:flex-row xs:items-center justify-between gap-1.5 sm:gap-2">
                        <span className="px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-emerald-700 text-white text-[9px] sm:text-xs font-black uppercase tracking-wider flex items-center gap-1 shrink-0 w-fit">
                          <CheckCircle2 className="w-3 h-3 sm:w-4 sm:h-4 text-emerald-300 shrink-0" />
                          <span>Vannam</span>
                        </span>
                        <span className="font-heading font-black text-base sm:text-2xl text-emerald-950">{current.stat}</span>
                      </div>

                      {/* Visual Score Gauge Bar */}
                      <div className="space-y-1 sm:space-y-1.5">
                        <div className="flex justify-between text-[9px] sm:text-xs font-black text-emerald-900">
                          <span className="truncate">Quality Score</span>
                          <span>98/100</span>
                        </div>
                        <div className="w-full h-2 sm:h-3 bg-emerald-200/80 rounded-full overflow-hidden p-0.5">
                      ...
                      <div className="space-y-2 sm:space-y-3 pt-1 sm:pt-2">
                        {current.vannamPoints.map((pt, i) => (
                          <div key={i} className="flex items-start sm:items-center gap-1.5 sm:gap-3 p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-white/90 border border-emerald-300/80 shadow-2xs">
                            <div className="w-4 h-4 sm:w-7 sm:h-7 rounded-md sm:rounded-xl bg-emerald-100 text-emerald-700 flex items-center justify-center font-black text-[10px] sm:text-sm shrink-0 mt-0.5 sm:mt-0">
                              ✓
                            </div>
                            <span className="text-[10px] sm:text-xs font-extrabold text-[#0F2963] leading-snug">{pt}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  {/* RIGHT PANEL: TRADITIONAL SCHOOLS (35% VISUAL GAUGE) */}
                  <div className="bg-gradient-to-br from-rose-50/70 to-slate-100/70 rounded-2xl sm:rounded-3xl p-3 sm:p-8 border sm:border-2 border-rose-200 space-y-3 sm:space-y-6 relative overflow-hidden opacity-90 flex flex-col justify-between">
                    <div className="space-y-3 sm:space-y-6">
                      <div className="flex flex-col xs:flex-row xs:items-center justify-between gap-1.5 sm:gap-2">
                        <span className="px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-slate-800 text-slate-200 text-[9px] sm:text-xs font-black uppercase tracking-wider flex items-center gap-1 shrink-0 w-fit">
                          <X className="w-3 h-3 sm:w-4 sm:h-4 text-rose-400 shrink-0" />
                          <span>Traditional</span>
                        </span>
                        <span className="font-heading font-bold text-xs sm:text-lg text-slate-500 whitespace-nowrap">Baseline</span>
                      </div>

                      {/* Visual Score Gauge Bar */}
                      <div className="space-y-1 sm:space-y-1.5">
                        <div className="flex justify-between text-[9px] sm:text-xs font-bold text-slate-600">
                          <span className="truncate">Quality Score</span>
                          <span>38/100</span>
                        </div>
                        <div className="w-full h-2 sm:h-3 bg-slate-200 rounded-full overflow-hidden p-0.5">
                      ...
                      <div className="space-y-2 sm:space-y-3 pt-1 sm:pt-2">
                        {current.traditionalPoints.map((pt, i) => (
                          <div key={i} className="flex items-start sm:items-center gap-1.5 sm:gap-3 p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-white/80 border border-rose-200/80 shadow-2xs">
                            <div className="w-4 h-4 sm:w-7 sm:h-7 rounded-md sm:rounded-xl bg-rose-100 text-rose-600 flex items-center justify-center font-black text-[10px] sm:text-sm shrink-0 mt-0.5 sm:mt-0">
                              ✕
                            </div>
                            <span className="text-[10px] sm:text-xs font-semibold text-slate-600 leading-snug">{pt}</span>
                          </div>
                        ))}
                      </div>
                    </div>
          ...
          <div className="bento-card p-6 sm:p-8 bg-gradient-to-r from-vannam-yellow/10 via-white to-vannam-cyan/10 border-2 border-vannam-yellow/30 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4 text-center sm:text-left">
              <div className="w-14 h-14 rounded-2xl bg-vannam-yellow text-[#0F2963] flex items-center justify-center text-2xl shrink-0 shadow-md font-bold">
                🧸
              </div>
              <div>
                <h4 className="font-heading font-extrabold text-xl text-[#0F2963]">See the difference with your own eyes</h4>
            ...
            <button
              onClick={() => { triggerConfetti(); setIsTourModalOpen(true); }}
              className="btn-primary px-8 py-3.5 text-xs sm:text-sm font-bold shrink-0 flex items-center justify-center gap-2 shadow-lg"
            >
              <Calendar className="w-4 h-4 text-vannam-yellow" />
      ...
      <section id="approach" className="scroll-mt-24 py-20 lg:py-28 bg-[#FFFDF8] bg-playful-dots border-y-2 border-[#E8EEFB] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border-2 border-[#CBD8F6] shadow-sm">
              <Compass className="w-4 h-4 text-[#0F2963] shrink-0" />
              <span className="text-xs font-black uppercase tracking-wider text-[#0F2963]">
                The 7-Shade Growth Spectrum
              </span>
            </div>

            <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-[#0F2963] leading-tight">
              How Children Learn & Flourish: <br className="hidden sm:block" />
              <span className="text-[#00A8E8] underline decoration-[#F59E0B] underline-offset-8">The 7 Shades</span> of Development
            </h2>

            <p className="text-base sm:text-lg text-[#334155] font-medium leading-relaxed max-w-2xl mx-auto">
          ...
          <div 
            className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center relative z-10 mb-16"
          >
            ...
            <div className="w-full lg:col-span-5 flex justify-center items-center relative py-4 lg:py-0">
              {(() => {
                ...
                return (
                  <div className="relative w-[270px] h-[270px] xs:w-[300px] xs:h-[300px] sm:w-[360px] sm:h-[360px] lg:w-[420px] lg:h-[420px] aspect-square rounded-full flex items-center justify-center mx-auto">
                    ...
                    {/* Center Hub */}
                    <div 
                      className="w-24 h-24 xs:w-28 xs:h-28 sm:w-36 sm:h-36 lg:w-40 lg:h-40 rounded-full z-20 flex flex-col items-center justify-center transition-all duration-500 bg-white shadow-xl p-2 text-center"
                      style={{ 
                        border: `4px solid ${currentShade.hex}`
                      }}
                    >
                      <ActiveIcon className="w-8 h-8 xs:w-10 xs:h-10 sm:w-14 sm:h-14 lg:w-16 lg:h-16 mb-1 transition-colors duration-500 shrink-0" style={{ color: currentShade.hex }} />
                      <span className="text-[8px] xs:text-[9px] sm:text-[10px] lg:text-[11px] font-black uppercase text-[#0F2963] leading-tight px-1">
                        {currentShade.title}
                      </span>
                    </div>
                    ...
                    {methodologyShades.map((shade, i) => {
                      ...
                      return (
                        <button
                          key={shade.id}
                          onClick={() => setActiveMethodologyShade(shade.id)}
                          onMouseEnter={() => setIsMethodologyAutoPaused(true)}
                          onMouseLeave={() => setIsMethodologyAutoPaused(false)}
                          aria-label={`Select ${shade.title}`}
                          className={`absolute w-9 h-9 xs:w-11 xs:h-11 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex flex-col items-center justify-center transition-all duration-300 group z-30 ${
                            isActive 
                              ? "shadow-2xl ring-3 sm:ring-4 ring-white scale-110" 
                        ...
                        >
                          ...
                          <Icon className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 stroke-[2.5] relative z-10" />
            ...
            <div className="w-full lg:col-span-7 relative">
              {(() => {
                ...
                return (
                  <div 
                    key={currentShade.id}
                    className="bg-white/90 backdrop-blur-xl rounded-3xl sm:rounded-[2rem] border-2 sm:border-[3px] p-5 sm:p-8 lg:p-10 shadow-2xl transition-all duration-700 relative overflow-hidden animate-in fade-in slide-in-from-bottom-3 lg:slide-in-from-right-4"
                    ...
                    <div className="relative z-10 space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex flex-wrap items-center gap-2.5">
                          <span 
                            className="px-4 py-1.5 rounded-full text-[11px] font-black uppercase tracking-wider flex items-center gap-1.5 shadow-sm"
                            style={{
                          ...
                          <span className="px-3 py-1.5 rounded-full bg-white text-[#0F2963] text-[10px] font-extrabold border border-[#CBD8F6] shadow-sm">
                            {currentShade.dailyDuration}
                          </span>
                        </div>

                        <div>
                          <h3 className="font-heading text-3xl sm:text-4xl font-extrabold text-[#0F2963] leading-tight mb-2 transition-colors duration-500">
                            {currentShade.title}
                          </h3>
                          <p className="text-sm sm:text-base font-bold italic" style={{ color: currentShade.hex }}>
                      ...
                      <div className="grid sm:grid-cols-2 gap-5 pt-4">
                        ...
                        <div className="bg-white rounded-2xl p-5 border border-[#E8EEFB] shadow-sm space-y-3">
                          <h4 className="font-heading font-extrabold text-sm text-[#0F2963] flex items-center gap-2 border-b border-[#F0F4FC] pb-2">
                            <Puzzle className="w-4 h-4" style={{ color: currentShade.hex }} />
                            <span>Tactile Tools Used</span>
                          </h4>
                          <ul className="space-y-2">
                            {currentShade.tools.map((tool, idx) => (
                              <li key={idx} className="flex items-start gap-2 text-[11px] font-medium text-[#334155]">
                                <span className="text-[14px] mt-0.5 leading-none" style={{ color: currentShade.hex }}>•</span>
                        ...
                        <div className="bg-white rounded-2xl p-5 border border-[#E8EEFB] shadow-sm space-y-3">
                          <h4 className="font-heading font-extrabold text-sm text-[#0F2963] flex items-center gap-2 border-b border-[#F0F4FC] pb-2">
                            <BookOpen className="w-4 h-4 text-vannam-orange" />
                            <span>Scientific Insight</span>
                          </h4>
                          <p className="text-xs text-[#0F2963] font-bold leading-relaxed bg-[#F0F4FC] p-3 rounded-xl border border-[#CBD8F6]">
                          ...
                          <ul className="space-y-1.5 mt-2">
                            {currentShade.milestones.slice(0, 2).map((milestone, idx) => (
                              <li key={idx} className="flex items-center gap-1.5 text-[11px] font-bold text-[#334155]">
                                <CheckCircle2 className="w-3.5 h-3.5" style={{ color: currentShade.hex }} />
                                <span>{milestone}</span>
                              </li>
                            ))}
                          </ul>
                      ...
                      <div className="pt-2">
                        <button
                          onClick={() => setIsTourModalOpen(true)}
                          className={`${currentShade.btnClass} w-full sm:w-auto px-6 sm:px-8 py-4 text-sm font-black flex items-center justify-center gap-2 shadow-lg transition-transform hover:-translate-y-1`}
                        >
          ...
          <div className="mt-12 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            ...
            <div className="bento-card card-yellow p-3 sm:p-6 space-y-1.5 sm:space-y-3 relative group">
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-[#F59E0B] text-[#0F2963] font-bold text-lg sm:text-2xl flex items-center justify-center shadow-md border-2 border-white">
                🌱
              </div>
              <h4 className="font-heading font-extrabold text-sm sm:text-lg text-[#0F2963] leading-tight">Self-Paced Freedom</h4>
              <p className="text-[11px] sm:text-xs text-[#334155] font-medium leading-snug line-clamp-3 sm:line-clamp-none">
                Children choose activities based on inner curiosity, building intrinsic focus without pressure.
              </p>
            </div>

            <div className="bento-card card-green p-3 sm:p-6 space-y-1.5 sm:space-y-3 relative group">
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-[#10B981] text-white font-bold text-lg sm:text-2xl flex items-center justify-center shadow-md border-2 border-white">
                🔬
              </div>
              <h4 className="font-heading font-extrabold text-sm sm:text-lg text-[#0F2963] leading-tight">Tactile STEAM Labs</h4>
              <p className="text-[11px] sm:text-xs text-[#334155] font-medium leading-snug line-clamp-3 sm:line-clamp-none">
                Touching, manipulating, and observing real materials connects abstract concepts to physical reality.
              </p>
            </div>

            <div className="bento-card card-cyan p-3 sm:p-6 space-y-1.5 sm:space-y-3 relative group">
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-[#00A8E8] text-white font-bold text-lg sm:text-2xl flex items-center justify-center shadow-md border-2 border-white">
                👩‍🏫
              </div>
              <h4 className="font-heading font-extrabold text-sm sm:text-lg text-[#0F2963] leading-tight">Loving 1:4 to 1:8 Ratio</h4>
              <p className="text-[11px] sm:text-xs text-[#334155] font-medium leading-snug line-clamp-3 sm:line-clamp-none">
                Every teacher acts as an observant guide, tailoring learning steps to each child&apos;s unique pace.
              </p>
            </div>

            <div className="bento-card card-red p-3 sm:p-6 space-y-1.5 sm:space-y-3 relative group">
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-[#F43F5E] text-white font-bold text-lg sm:text-2xl flex items-center justify-center shadow-md border-2 border-white">
                📱
              </div>
              <h4 className="font-heading font-extrabold text-sm sm:text-lg text-[#0F2963] leading-tight">Parent Portal Updates</h4>
              <p className="text-[11px] sm:text-xs text-[#334155] font-medium leading-snug line-clamp-3 sm:line-clamp-none">
      ...
      <section id="activities" className="scroll-mt-24 py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14 space-y-3">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0F2963] tracking-tight leading-tight">
              Joyful <span className="text-vannam-red underline decoration-vannam-yellow underline-offset-8">Daily Activities</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-start">
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`shrink-0 snap-center min-w-[200px] sm:min-w-[220px] lg:min-w-0 w-auto lg:w-full text-left p-3 sm:p-4 rounded-2xl transition-all duration-200 flex items-center gap-3 border-2 group ${
                      isActive 
                        ? `bg-white shadow-md ${tab.activeBorder}` 
                        : "bg-white/70 border-[#CBD8F6]/60 hover:bg-white hover:border-[#CBD8F6]"
                    }`}
                  >
                    <div className={`w-10 h-10 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center transition-colors shrink-0 ${isActive ? tab.bg : "bg-[#F0F4FC] group-hover:bg-gray-100"}`}>
            ...
            {/* Dynamic Activity Cards Grid - 2 per row on Mobile like Amazon/Flipkart */}
                  ...
                  .map((act, i) => {
                    ...
                    return (
                      <div 
                        ...
                        className={`relative overflow-hidden rounded-2xl sm:rounded-3xl border-2 bg-gradient-to-br ${act.bgClass} p-3.5 sm:p-6 shadow-xs hover:shadow-lg transition-all duration-300 group hover:-translate-y-1 flex flex-col justify-between`}
                      >
                        ...
                        <div className="relative z-10 space-y-1 sm:space-y-1.5">
                          ...
                          <h3 className="font-heading font-extrabold text-[#0F2963] text-xs sm:text-base leading-tight line-clamp-1">
                            {act.title}
                          </h3>
                          <p className="text-[11px] sm:text-xs font-medium text-[#334155] leading-snug line-clamp-2 sm:line-clamp-3">
                            {act.desc}
                          </p>
                        </div>
                      </div>
      ...
      {/* FACILITIES SECTION */}
      <section id="facilities" className="scroll-mt-24 py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0F2963] tracking-tight leading-tight">
              ...
              <span className="text-vannam-green underline decoration-vannam-yellow underline-offset-8">Safety & Wonder</span>
            </h2>
            <p className="text-base sm:text-lg text-[#334155] leading-relaxed">
            ...
            {facilities.map((fac, idx) => (
              <div key={idx} className={`bento-card overflow-hidden border-2 ${fac.accent} group flex flex-col justify-between`}>
                <div className="relative h-28 sm:h-48 w-full overflow-hidden">
                  ...
                  />
                  <div className="absolute top-2 right-2 sm:top-3 sm:right-3 bg-white/90 backdrop-blur-md px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[9px] sm:text-[11px] font-extrabold text-[#0F2963] shadow-xs">
                    {fac.tag}
                  </div>
                </div>
                <div className="p-3 sm:p-6 space-y-1 sm:space-y-2">
                  <h3 className="font-heading font-extrabold text-sm sm:text-xl text-[#0F2963] line-clamp-1">{fac.title}</h3>
                  <p className="text-[11px] sm:text-sm text-[#334155] leading-snug line-clamp-2 sm:line-clamp-none">{fac.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="safety" className="scroll-mt-24 py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14 space-y-3">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0F2963] tracking-tight leading-tight">
              ...
              <span className="text-vannam-green underline decoration-vannam-yellow underline-offset-8">Comes First. Always.</span>
            </h2>
            <p className="text-sm sm:text-base text-[#334155] leading-relaxed">
          ...
          {/* 4 Safety Pillars - 2x2 Grid on Mobile like Amazon/Flipkart */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8 sm:mb-12">
            {[
              ...
              return (
                <div 
                  key={idx} 
                  className={`bento-card ${item.color} p-3 sm:p-5 flex flex-col justify-between hover:-translate-y-1.5 transition-all duration-200 group`}
                >
                  <div>
                    {/* Photo with Tag */}
                    <div className="relative h-28 sm:h-44 w-full rounded-xl sm:rounded-2xl overflow-hidden mb-3">
                      <Image 
                        src={item.image} 
                        alt={item.title} 
                        fill 
                        ...
                        className="object-cover group-hover:scale-105 transition duration-500" 
                      />
                      <span className={`absolute top-2 right-2 sm:top-2.5 sm:right-2.5 px-2 py-0.5 rounded-full text-[8px] sm:text-[10px] font-black ${item.badgeColor} shadow-xs`}>
                        {item.badge}
                      </span>
                    </div>
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5">
                        <div className="w-5 h-5 rounded-md bg-white/80 flex items-center justify-center text-[#0F2963] shrink-0">
                          <Icon className="w-3.5 h-3.5" />
                        </div>
                        <h3 className="font-heading font-extrabold text-xs sm:text-base text-[#0F2963] leading-tight line-clamp-1">
                          {item.title}
                        </h3>
                      </div>
                      <p className="text-[11px] sm:text-xs text-[#334155] leading-snug line-clamp-2 sm:line-clamp-3">
                        {item.desc}
                      </p>
                    </div>
                  </div>

                  <div className="pt-2 sm:pt-3 border-t border-black/5 mt-2 flex items-center gap-1 text-[10px] sm:text-xs font-black text-emerald-800">
      ...
      <section id="teachers" className="scroll-mt-24 py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0F2963] tracking-tight leading-tight">
              ...
              <span className="text-vannam-yellow underline decoration-vannam-green underline-offset-8">Warm Teachers</span>
            </h2>
            <p className="text-base sm:text-lg text-[#334155] leading-relaxed">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-8">
            {teachers.map((t, idx) => (
              <div key={idx} className="bento-card p-3 sm:p-6 space-y-2 sm:space-y-4 hover:-translate-y-2 transition duration-200 flex flex-col justify-between">
                <div>
                  <div className="relative h-32 sm:h-56 w-full rounded-xl sm:rounded-2xl overflow-hidden mb-2">
                    <Image src={t.image} alt={t.name} fill sizes="(max-width: 768px) 50vw, (max-width: 1200px) 50vw, 33vw" className="object-cover" />
                    <span className={`absolute top-2 right-2 sm:top-3 sm:right-3 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[9px] sm:text-[10px] font-extrabold ${t.badgeColor} shadow-xs`}>
                      {t.badge}
                    </span>
                  </div>
                  <div className="space-y-0.5 sm:space-y-1">
                    <h3 className="font-heading font-extrabold text-sm sm:text-xl text-[#0F2963] truncate">{t.name}</h3>
                ...
                <p className="text-[11px] sm:text-xs text-[#334155] leading-snug line-clamp-2 sm:line-clamp-none">{t.intro}</p>
              </div>
            ))}
          </div>
      ...
      <section id="gallery" className="scroll-mt-24 py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-4">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0F2963] tracking-tight leading-tight">
              Moments of <span className="text-vannam-cyan underline decoration-vannam-yellow underline-offset-8">Joy & Discovery</span>
            </h2>
            <p className="text-base sm:text-lg text-[#334155] leading-relaxed">
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-3 mb-10 scrollbar-none snap-x justify-start sm:justify-center px-1">
            {["all", "classroom", "activities", "events", "sports", "celebrations", "outdoor"].map((cat) => (
              <button
                key={cat}
                onClick={() => setGalleryCategory(cat)}
                className={`px-4 py-2 rounded-xl text-xs font-extrabold capitalize transition shrink-0 snap-center ${
                  galleryCategory === cat
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
            {filteredGallery.map((item) => (
              <div 
                ...
                className="group relative h-40 sm:h-64 rounded-2xl overflow-hidden cursor-pointer border-2 border-[#CBD8F6] shadow-xs hover:border-vannam-yellow/40 transition"
              >
                <Image 
                  src={item.src} 
                  alt={item.title} 
        ...
        <div className="fixed inset-0 z-50 bg-[#091A42]/95 backdrop-blur-md flex items-center justify-center p-4">
          <div className="relative max-w-4xl w-full bg-[#0F2963] rounded-3xl border-4 border-[#F59E0B] overflow-hidden shadow-2xl border border-slate-800">
            <button
              ...
              className="absolute top-4 right-4 z-10 bg-[#0F2963]/80 hover:bg-slate-700 p-2 rounded-full text-white transition"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            <div className="p-4 bg-slate-900 text-white flex items-center justify-between">
              <span className="font-heading font-extrabold text-lg">{activeLightboxImage.title}</span>
              <span className="text-xs uppercase font-extrabold text-vannam-yellow px-3 py-1 bg-[#0F2963] rounded-full">
      ...
      <section id="awards" className="scroll-mt-24 py-20 lg:py-28 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
            ...
            <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0F2963] tracking-tight leading-tight">
              A Legacy of <span className="text-[#00A8E8] underline decoration-[#F59E0B] underline-offset-8">Excellence</span>
            </h2>
          </div>

          {/* MOBILE / TABLET VIEW: Clean 2x2 Grid (Like Amazon / Flipkart) */}
          <div className="lg:hidden grid grid-cols-2 gap-3 sm:gap-5">
            {awardsData.map((award) => (
              <div
                key={award.id}
                onClick={() => setSelectedAwardModal(award)}
                className={`bento-card p-3.5 sm:p-5 bg-gradient-to-br ${award.accentBg} flex flex-col justify-between hover:-translate-y-1 transition-all duration-200 cursor-pointer group shadow-xs`}
              >
                <div>
                  {/* Top Bar with Icon & Year */}
                  <div className="flex items-center justify-between mb-3">
                    <div className="w-10 h-10 rounded-xl bg-white border border-[#CBD8F6] flex items-center justify-center text-xl shadow-xs">
                      {award.icon}
                    </div>
                  ...
                  <div className="space-y-1 mb-2">
                    <span className={`inline-block px-2.5 py-0.5 rounded-full text-[9px] font-black shadow-2xs ${award.badgeClass}`}>
                      {award.badge}
                    </span>
                    <h3 className="font-heading font-extrabold text-sm sm:text-base text-[#0F2963] leading-tight line-clamp-2">
                      {award.title}
                    </h3>
                  </div>

                  <p className="text-[11px] text-[#334155] leading-snug line-clamp-2 mb-2 font-medium">
                    {award.desc}
                  </p>
                </div>

                <div className="pt-2 border-t border-black/5 flex items-center justify-between text-[10px] font-black text-[#00A8E8]">
      ...
      <section id="testimonials" className="scroll-mt-24 py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0F2963] tracking-tight leading-tight">
              ...
              <span className="text-vannam-yellow underline decoration-vannam-cyan underline-offset-8">Happy Families</span>
            </h2>
            <p className="text-base sm:text-lg text-[#334155] leading-relaxed">
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory scrollbar-none gap-4 md:grid md:grid-cols-3 md:gap-8 pb-4">
            {testimonials.map((t, idx) => (
              <div key={idx} className="w-[85vw] shrink-0 snap-center md:w-auto bento-card p-6 sm:p-8 space-y-6 flex flex-col justify-between hover:-translate-y-1.5 transition-all duration-200">
                <div className="space-y-4">
      ...
      <section className="py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {upcomingEvents.map((ev, idx) => (
              <div key={idx} className="bento-card p-4 sm:p-6 flex items-start gap-3 sm:gap-6 hover:border-vannam-yellow/40 hover:-translate-y-1 transition-all duration-200">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-vannam-yellow text-[#0F2963] flex flex-col items-center justify-center shrink-0 shadow-md">
                  <span className="font-heading font-black text-lg sm:text-xl leading-none">{ev.date.split(" ")[1]}</span>
                  <span className="text-[10px] font-extrabold uppercase tracking-widest">{ev.date.split(" ")[0]}</span>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-heading font-extrabold text-xl text-[#0F2963]">{ev.title}</h3>
                  <p className="text-xs text-[#334155]">{ev.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 lg:py-24 bg-[#FFFDF8] bg-playful-dots border-y border-[#CBD8F6]/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-14 space-y-4">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0F2963] tracking-tight leading-tight">
              Frequently Asked <span className="text-vannam-green underline decoration-vannam-yellow underline-offset-8">Questions</span>
            </h2>
          </div>

          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div key={idx} className="bento-card p-6 bg-white">
                <button
                  onClick={() => setActiveFaq(activeFaq === idx ? null : idx)}
                  className="w-full flex items-center justify-between text-left gap-4"
                >
                  <span className="font-heading font-extrabold text-[#0F2963] text-lg sm:text-xl">
                    {faq.q}
                  </span>
                  <ChevronDown className={`w-5 h-5 text-[#64748B] transition transform ${activeFaq === idx ? "rotate-180 text-vannam-yellow" : ""}`} />
                </button>
                {activeFaq === idx && (
                  <p className="mt-4 text-sm text-[#334155] leading-relaxed pt-3 border-t border-[#E8EEFB]">
                    {faq.a}
                  </p>
                )}
              </div>
      ...
      {/* ADMISSION CTA & CONTACT FORM SECTION - GLASSMORPHIC POSTCARD REDESIGN */}
      <section id="contact" className="scroll-mt-24 py-20 lg:py-32 bg-[#0F2963] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 space-y-8">
              <span className="px-4 py-2 rounded-full bg-white/10 border border-white/20 text-[#FDE68A] text-[11px] font-black uppercase tracking-widest inline-flex items-center gap-2 shadow-sm backdrop-blur-md">
                <Calendar className="w-4 h-4 text-[#FDE68A]" />
                <span>Admissions Open</span>
              </span>

              <h2 className="font-heading text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-[1.1] text-white drop-shadow-sm">
              ...
              <div className="space-y-5 pt-4">
                <div className="flex items-center gap-4 group">
                  <div className="w-12 h-12 rounded-2xl bg-white/10 border border-white/20 backdrop-blur-md flex items-center justify-center shadow-lg transition-transform group-hover:scale-110 shrink-0">
                    <MapPin className="w-5 h-5 text-[#F59E0B]" />
                  </div>
                  <span className="font-bold text-blue-50 text-sm">Rainbow Gardens Campus, 124 Academy Drive</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="font-bold text-blue-50 text-sm">Direct Admissions: +1 (800) 555-PLAY</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="font-bold text-blue-50 text-sm break-all sm:break-normal">admissions@vannamworld.edu</span>
                </div>
              </div>
            </div>

            {/* Right Contact Form - Glassmorphic Postcard */}
            <div className="lg:col-span-7 relative">
              <div className="bg-white/10 backdrop-blur-2xl p-8 sm:p-12 rounded-[2.5rem] border-2 border-white/20 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                ...
                {enquirySubmitted ? (
                  <div className="p-8 rounded-3xl bg-white/10 border border-[#10B981]/50 backdrop-blur-md text-center space-y-4 animate-in zoom-in-95 duration-500">
                    <div className="w-20 h-20 bg-[#10B981] rounded-full flex items-center justify-center mx-auto shadow-lg shadow-[#10B981]/30">
                      <CheckCircle2 className="w-10 h-10 text-white" />
                    </div>
                    <h4 className="font-heading font-extrabold text-white text-2xl">
                      Enquiry Received!
                    </h4>
                  ...
                  <form onSubmit={handleEnquirySubmit} className="space-y-5 relative z-10">
                    <div className="grid grid-cols-2 gap-3 sm:gap-5">
                      <div>
                        <label className="block text-[10px] font-black text-blue-100 uppercase tracking-widest mb-1.5 ml-1">Parent Name *</label>
                        <input
                          type="text"
                          required
                          value={enquiryForm.parentName}
                          onChange={(e) => setEnquiryForm({ ...enquiryForm, parentName: e.target.value })}
                          className="w-full px-3 sm:px-5 py-3 sm:py-4 rounded-2xl bg-white/90 border-2 border-transparent text-[#0F2963] text-xs sm:text-sm font-bold shadow-inner focus:outline-none focus:ring-4 focus:ring-[#F59E0B]/30 focus:border-[#F59E0B] transition-all placeholder:text-[#64748B]/50"
                          placeholder="e.g. Sarah J."
                        />
                      </div>

                      <div>
                        <label className="block text-[10px] font-black text-blue-100 uppercase tracking-widest mb-1.5 ml-1">Child Name *</label>
                        <input
                          type="text"
                          required
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:gap-5">
                      <div>
                        <label className="block text-[10px] font-black text-blue-100 uppercase tracking-widest mb-1.5 ml-1">Phone Number *</label>
                        <input
                          type="tel"
                          required
                          value={enquiryForm.phone}
                          onChange={(e) => setEnquiryForm({ ...enquiryForm, phone: e.target.value })}
                          className="w-full px-3 sm:px-5 py-3 sm:py-4 rounded-2xl bg-white/90 border-2 border-transparent text-[#0F2963] text-xs sm:text-sm font-bold shadow-inner focus:outline-none focus:ring-4 focus:ring-[#00A8E8]/30 focus:border-[#00A8E8] transition-all placeholder:text-[#64748B]/50"
                          placeholder="+1 (555) 000"
                        />
                      </div>

                      <div>
                        <label className="block text-[10px] font-black text-blue-100 uppercase tracking-widest mb-1.5 ml-1">Email Address *</label>
                        <input
                          type="email"
                          required
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:gap-5">
                      <div>
                        <label className="block text-[10px] font-black text-blue-100 uppercase tracking-widest mb-1.5 ml-1">Child Age *</label>
                        <select
                          value={enquiryForm.childAge}
                          onChange={(e) => setEnquiryForm({ ...enquiryForm, childAge: e.target.value })}
                          className="w-full px-3 sm:px-5 py-3 sm:py-4 rounded-2xl bg-white/90 border-2 border-transparent text-[#0F2963] text-xs sm:text-sm font-bold shadow-inner focus:outline-none focus:ring-4 focus:ring-[#8B5CF6]/30 focus:border-[#8B5CF6] transition-all cursor-pointer"
                        >
                      ...
                      <div>
                        <label className="block text-[10px] font-black text-blue-100 uppercase tracking-widest mb-1.5 ml-1">Preferred Program</label>
                        <select
                    ...
                    <div>
                      <label className="block text-[10px] font-black text-blue-100 uppercase tracking-widest mb-1.5 ml-1">Message / Questions</label>
                      <textarea
                        rows={3}
                        value={enquiryForm.message}
                        onChange={(e) => setEnquiryForm({ ...enquiryForm, message: e.target.value })}
                        className="w-full px-5 py-4 rounded-2xl bg-white/90 border-2 border-transparent text-[#0F2963] text-sm font-bold shadow-inner focus:outline-none focus:ring-4 focus:ring-[#F43F5E]/30 focus:border-[#F43F5E] transition-all placeholder:text-[#64748B]/50 resize-none"
                    ...
                    <button
                      type="submit"
                      className="btn-yellow w-full py-5 text-lg font-black flex items-center justify-center gap-3 rounded-2xl shadow-[0_8px_30px_-5px_rgba(245,158,11,0.5)] transition-all hover:-translate-y-1 mt-4"
                    >
      ...
      <footer className="bg-gradient-to-b from-[#FFFDF9] via-[#FFF7ED] to-[#FFEDD5] text-[#0F2963] pt-16 pb-24 lg:pb-12 border-t-2 border-[#FDBA74]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-x-6 gap-y-10 sm:gap-8">
            
            {/* Brand Col */}
            <div className="col-span-2 lg:col-span-2 space-y-5">
              <div className="flex items-center gap-3">
                <div className="bg-white p-2 rounded-2xl inline-block shadow-sm border border-[#FED7AA]">
                  <Image 
                    src="/logo.png" 
                    alt="Vannam World Preschool Logo" 
                    width={180}
              ...
              <p className="text-sm text-[#475569] leading-relaxed max-w-sm font-medium">
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-white text-[#EA580C] border border-[#FED7AA] flex items-center justify-center hover:bg-[#EA580C] hover:text-white transition-all shadow-2xs hover:scale-110"
                >
            ...
            {/* Quick Links */}
            <div className="space-y-4">
              <h4 className="font-heading font-extrabold text-sm text-[#C2410C] uppercase tracking-wider">Quick Links</h4>
              <ul className="space-y-3 text-sm text-[#475569] font-semibold">
            ...
            {/* Programs */}
            <div className="space-y-4">
              <h4 className="font-heading font-extrabold text-sm text-[#C2410C] uppercase tracking-wider">Programs</h4>
              <ul className="space-y-3 text-sm text-[#475569] font-semibold">
            ...
            <div className="col-span-2 lg:col-span-1 space-y-4">
              <h4 className="font-heading font-extrabold text-sm text-[#C2410C] uppercase tracking-wider">Campus Contact</h4>
              <div className="space-y-2 text-sm text-[#475569] font-medium">
                ...
                <p className="text-[#C2410C] font-extrabold text-base mt-2">+1 (800) 555-PLAY</p>
                <p className="text-[#0F2963] font-bold">admissions@vannamworld.edu</p>
              </div>
            </div>

          </div>

          <div className="pt-8 border-t border-[#FED7AA] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-[#64748B]">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-t border-[#CBD8F6] px-3 py-2 flex items-center justify-around text-center shadow-[0_-4px_20px_rgba(0,0,0,0.08)] pb-[calc(0.5rem+env(safe-area-inset-bottom,0px))]">
        <a 
          href="tel:+18005557529"
          className="flex flex-col items-center justify-center gap-0.5 text-[#0F2963] hover:text-vannam-green transition py-1 px-2 group"
        >
        ...
        <button 
          onClick={() => { triggerConfetti(); setIsTourModalOpen(true); }}
          className="flex flex-col items-center justify-center gap-0.5 text-[#0F2963] transition py-1 px-2 group"
        >
          <div className="w-8 h-8 rounded-full bg-amber-100 text-[#D97706] flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <button 
          onClick={() => setIsFeeCalcOpen(true)}
          className="flex flex-col items-center justify-center gap-0.5 text-[#0F2963] hover:text-[#00A8E8] transition py-1 px-2 group"
        >
          <div className="w-8 h-8 rounded-full bg-sky-50 text-[#00A8E8] flex items-center justify-center group-hover:scale-110 transition-transform">
            <Calculator className="w-4 h-4" />
          </div>
        ...
        <button 
          onClick={() => setIsPortalModalOpen(true)}
          className="flex flex-col items-center justify-center gap-0.5 text-[#0F2963] hover:text-vannam-yellow transition py-1 px-2 group"
        >
